			...
			case 4:
				...
				if(brigade2.getNom().equals(ChoixBrigade))
					poneyList.forEach(poney2->{
						...
						System.out.println("le poney "+ poney2.getNom() +" a été recruté par la brigade " +brigade2.getNom());
					});
				});
				break;
				...
				missionList.forEach(mission2->{
					if(mission2.getNom().equals(ChoixMission))
						brigadeList.forEach(brigade2->{
							...
							System.out.println("la brigade " + brigade2.getNom() + "a été affecté à la mission" + mission2.getNom());
						});
					});
				break;
				...
				brigadeList.forEach(brigade2->{
					if(brigade2.getNom().equals(ChoixBrigade3))
						poneyList.forEach(poney2->{
							...
							System.out.println("la poney " + poney2.getNom() + "a été viré de la brigade" + brigade2.getNom());
						});
					});
				break;
				...
				missionList.forEach(mission2->{
					if(mission2.getNom().equals(ChoixMission2))
						brigadeList.forEach(brigade2->{
							...
							System.out.println("la brigade " + brigade2.getNom() + "a terminé la mission" + mission2.getNom());
						});
					});
				break;
